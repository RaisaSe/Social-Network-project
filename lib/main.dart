  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: 'AIzaSyDcbkCtQfmZVce3D_ZkxefkBHfxu9JCTQM',
        appId: '1:1070605114153:web:d5c008ffcfd1ce909a7538',
        messagingSenderId: '1070605114153',
        projectId: 'students-network',
        storageBucket: 'students-network.appspot.com',
      ),
    );
  } else {
    await Firebase.initializeApp();
